...
#macro SCRIBBLE_DEFAULT_BLINK_ON_DURATION   30       //Default duration that blinking text should stay on for, in milliseconds
#macro SCRIBBLE_DEFAULT_BLINK_OFF_DURATION  30       //Default duration that blinking text should turn off for, in milliseconds
